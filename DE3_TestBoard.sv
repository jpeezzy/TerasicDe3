...
//=======================================================
`include "S7Constants.vh"
module DE3_TestBoard(
...
//  Structural coding
//=======================================================
assign LEDR = 8'b11111110; //Turn ON the LEDR0~LEDR7
assign LEDG = 8'hff; //Turn OFF the LEDG0~LEDG7
assign LEDB = 8'hff; // Turn OFF the LEDB0~LEDB7
//assign HEX0 = `ONE;
//assign HEX0_DP = 1'b0;
